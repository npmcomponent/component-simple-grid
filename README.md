*This repository is a mirror of the [component](http://component.io) module [component/simple-grid](http://github.com/component/simple-grid). It has been modified to work with NPM+Browserify. You can install it using the command `npm install npmcomponent/component-simple-grid`. Please do not open issues or send pull requests against this repo. If you have issues with this repo, report it to [npmcomponent](https://github.com/airportyh/npmcomponent).*
<h2>Simple Grid</h2>
<h3>Intro</h3>
